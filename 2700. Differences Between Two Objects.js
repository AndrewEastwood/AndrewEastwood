 ...
 * @return {object}
 */
function objDiff(obj1, obj2, diff = {}) {
  for (let key in obj1) {
    let bothArrays = Array.isArray(obj1[key]) && Array.isArray(obj2[key]);
    let bothObjects = typeof obj1[key] === 'object' &&
      typeof obj2[key] === 'object' &&
      !Array.isArray(obj1[key]) &&
      !Array.isArray(obj2[key]);
    if (bothObjects || bothArrays) {
      diff[key] = diff[key] ?? {};
      objDiff(obj1[key], obj2[key], diff[key]);
